...
class DatabaseConnection():
    def __init__(self, host="localhost", user=db_user, password=db_password, database=db_database):
        self.host = host
        self.user = user
...
class DeleteDialog(QDialog):
    def __init__(self):
        ...
        confirmation = QLabel("Are you sure you want to delete student data?")
        yes = QPushButton("Yes")
        no = QPushButton("No")
